 ...
 */
 ...
 function display_room_booking_form() {
    ...
    if (isset($_POST['submit_booking'])) {
        ...
        $output .= "<p>Thank you, $name! Your booking for {$room_details['name']} has been received.</p>";
    }

    $output = '
    <style>
        /* General styles for the room booking display */
...
/* Styling for the cost breakdown */
.cost-breakdown p {
    font-weight: bold;
    display: flex;
